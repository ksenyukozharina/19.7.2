...
class PetFriends:
    ...
    def update_new_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет (постит) на сервер данные об обновляемом фото питомца и возвращает статус
